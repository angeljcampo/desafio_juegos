...
class JuegosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create juego" do
    assert_difference('Juego.count') do
      post juegos_url, params: { juego: { boardphoto: @juego.boardphoto, name: @juego.name, piecephoto: @juego.piecephoto, rules: @juego.rules } }
    end
  ...
  test "should update juego" do
    patch juego_url(@juego), params: { juego: { boardphoto: @juego.boardphoto, name: @juego.name, piecephoto: @juego.piecephoto, rules: @juego.rules } }
